  ...
  return (
    <>
      ...
      <div style={{ background: "#0e0a07", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", overflow: "hidden", marginBottom: "10px" }}>
        {/* Hero */}
        <div style={{ height: "68px", background: heroColor, display: "flex", alignItems: "flex-start", justifyContent: "space-between", padding: "10px 14px" }}>
          <div style={{ width: "26px", height: "26px", borderRadius: "50%", background: "rgba(255,255,255,0.1)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: "600", color: "rgba(255,255,255,0.6)" }}>{index + 1}</div>
          <span style={{ fontSize: "10px", fontWeight: "600", padding: "3px 10px", borderRadius: "20px", background: badgeColor.bg, color: badgeColor.color, letterSpacing: "1px", textTransform: "uppercase" }}>{isNearby ? "closer" : "go far"}</span>
        </div>
