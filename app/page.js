  ...
  return (
    <>
      ...
      <div style={{ background: "#0e0a07", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", overflow: "hidden", marginBottom: "10px" }}>
        {/* Hero */}
        <div style={{ height: "140px", background: heroColor, display: "flex", alignItems: "flex-start", justifyContent: "space-between", padding: "10px 14px", backgroundImage: `url(https://source.unsplash.com/600x300/?${encodeURIComponent(trip.destination + ' ' + trip.country + ' travel')})`, backgroundSize: "cover", backgroundPosition: "center", position: "relative" }}>
